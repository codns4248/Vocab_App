package com.forevermemory.vocaapp; //  본인 패키지 이름이 맞는지 맨 윗줄 확인
                ...
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (user != null) {
                            ...
                            com.forevermemory.vocaapp.Test.StudyManager.getInstance().updateFCMToken(user.getUid());

                            // 신규 가입 유저라면 기본 포인트 100P를 지급합니다.
                            if (isNewUser) {
                                com.forevermemory.vocaapp.Test.StudyManager.getInstance().initNewUserPoint(user.getUid());
                            }
                        }
